...
laser_origin = [0,0,0];
        %outside
person_coords = [-0.5,-0.5,-0.65];
        %inside
%person_coords = [0.75 ,0 ,-0.65];

    %Display environment objects
PlaceObject('roboticshuman.ply', person_coords);    
 hold on;
PlaceObject('lasergate.ply', [0,0, 0.05]);     
hold on;
PlaceObject('lasergate.ply', [1.5,0,0.05]);  
hold on;
...
axis equal;
    ...
    %Laser beam 2
laserStartPnt2 = [0,0,0.2];
laserEndPnt2 = [1.5,0,0.2];
...
axis equal;
    ...
    %Laser beam 3
laserStartPnt3 = [0,0,0.4];
laserEndPnt3 = [1.5,0,0.4];
...
axis equal;
    ...
    %Laser beam 4
laserStartPnt4 = [0,0,-0.2];
laserEndPnt4 = [1.5,0,-0.2];
