classdef DobotMagician1 < RobotBaseClass
    %% DobotMagician1
    % This class is based on the DobotMagician1. 
    ...
    properties(Access =public)   
        plyFileNameStem = 'DobotMagician1';
...
%% Test Move DobotMagician1
    function TestMoveDobotMagician1(self)
...
%% RealQToModelQ
        ...
        function modelQ = RealQToModelQ(realQ)
            modelQ = realQ;
            modelQ(3) = DobotMagician1.ComputeModelQ3GivenRealQ2and3( realQ(2), realQ(3) );
...
%% ModelQToRealQ
        ...
        function realQ = ModelQToRealQ( modelQ )
            realQ = modelQ;
            realQ(3) = DobotMagician1.ComputeRealQ3GivenModelQ2and3( modelQ(2), modelQ(3) );
        end
