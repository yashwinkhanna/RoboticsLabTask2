...
%Enable joint controller
Joint_Controller(robot); %break at line 24 'set' when enabled
...
set(HF,'Position',[0.1 0.1 0.8 0.8]); %break here for simple teach (joint controller)
